...
const Header = () => {
  ...
  <nav className="navbar">
      <div className="nintendo-logo">
          <svg className="cla-svg-icon plo-header__logo" style={{
            width: "90px",
            height: "52px",
            padding: "10px",
            
          }} stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 32">
      ...
      <ul className='header'>
        <li><img src="../../assets/Logo e Svg/ricerca.svg" />
          Cerca</li>
        <li><img src="#" />
          Whishlist</li>
        <li><img src="#" />
